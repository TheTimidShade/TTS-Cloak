...
if (isClass(configFile >> "CfgPatches" >> "ace_main")) then
{
	...
	private _category = ["tts_cloak_actions", "TTS Cloak", "scripts\tts_cloak\icons\cloak_man.paa",
		// statement
		{}, 
		// condition
		{
	...
	private _activateAction = ["ActivateCloak", localize "STR_tts_cloak_action_activateCloak", "scripts\tts_cloak\icons\cloak_man.paa",
		// statement
		{
	...
	private _deactivateAction = ["DeactivateCloak", localize "STR_tts_cloak_action_deactivateCloak", "scripts\tts_cloak\icons\cloak_remove.paa",
		// statement
		{
