...
if (isClass(configFile >> "CfgPatches" >> "ace_main")) then
{
	...
	private _category = ["tts_cloak_actions", "TTS Active Camo", "\tts_cloak\icons\cloak_vehicle.paa",
		// statement
		{}, 
		// condition
		{
	...
	private _activateAction = ["ActivateCloak", localize "STR_tts_cloak_action_activateVehicleCamo", "\tts_cloak\icons\cloak_vehicle.paa",
		// statement
		{
	...
	private _deactivateAction = ["DeactivateCloak", localize "STR_tts_cloak_action_deactivateVehicleCamo", "\tts_cloak\icons\cloak_vehicle.paa",
		// statement
		{
